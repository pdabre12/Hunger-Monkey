    ...
    async function handleRegister(e){
      ...
      axios.post("http://localhost:8000/restaurants/api/auth/register",
            ...
            .then(res=>{
               ...
               localStorage.setItem("token", restemail);
               ...
               <form onSubmit={handleRegister}>
                ...
                <div className="form-group">
                  ...
                  <div className="form-group">
                     ...
                     <input type="text" id="reststate" className="form-control" value={reststate} onChange={e=>setreststate(e.target.value)} placeholder="City" required/>
                  </div>
                  <div className="form-group">
                     <label>Restaurant Country</label>
                     <input type="text" id="restcountry" className="form-control" value={restcountry} onChange={e=>setrestcountry(e.target.value)} placeholder="City" required/>
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                     ...
                     <input type="text" id="restcuisine" className="form-control" value={restcuisine} onChange={e=>setrestcuisine(e.target.value)} placeholder="Description" required/>
                  </div>
                  <div className="form-group">
                     <label>Opens At</label>
                     <input type="text" id="restopensat" className="form-control" value={restopensat} onChange={e=>setrestopensat(e.target.value)} placeholder="Opens At" required/>
                  </div>
                  <div className="form-group">
                     <label>Closes At</label>
                     <input type="text" id="restclosesat" className="form-control" value={restclosesat} onChange={e=>setrestclosesat(e.target.value)} placeholder="Closes At" required/>
                  </div>
                  <div className="form-group">
                     <label>Delivery Fee</label>
                     <input type="number" id="restdeliveryfee" className="form-control" value={restdeliveryfee} onChange={e=>setrestdeliveryfee(e.target.value)} placeholder="Delivery fee" required/>
                  </div>
{/*          
                  <div className="form-group">
