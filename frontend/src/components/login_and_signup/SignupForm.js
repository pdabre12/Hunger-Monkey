    ...
    function handleRegister(e){
      ...
      axios.post(process.env.REACT_APP_BACKEND+"user/api/auth/register",{
            ...
            //       console.log(response)
                 ...
                 console.log(err)
                 seterrors("User already exists! Try a different email address or login!")
              })
         ...
         {redirectVar}
            ...
            <h2><b>Customer Registration</b></h2>
               ...
               <form onSubmit={handleRegister} enctype="multipart/form-data">
                  ...
                  <div className="form-group">
                     <label>Address</label>
                     <input type="text" value={uaddr} id="uaddr" ref={inputRef} onSelect={e=>setuaddr(e.target.value)} className="form-control" placeholder="Address" onChange={e => setuaddr(e.target.value)} required/>
                  </div>
                  <div className="form-group">
                     <label>Zipcode</label>
